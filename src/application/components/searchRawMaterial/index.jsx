...
import { getAllRawMaterials } from "application/rawMaterial/service";
      ...
      <div className="px-4 w-full max-w-md overflow-x-auto max-h-screen sm:max-w-xl md:max-w-3xl md:h-auto">
        <div className="relative bg-white rounded-2xl shadow-lg pb-4">
          <div className="flex justify-between items-start p-5 rounded-t border-b">
            <div>
              <h3 className="font-medium text-lg">Buscar materia prima</h3>
              <p className="pt-2 text-sm text-gray-400">
                Escanee con un lector de códigos de barra o seleccione la
                materia prima a continuación.
              </p>
            </div>
            <button
              onClick={handleClose}
